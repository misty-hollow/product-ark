...
export function UserProfileCard({ user }: UserProfileCardProps) {
  return (
    <section className="border border-stone-200 bg-[#FFFCF4] p-5 shadow-sm">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <span className="flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden border border-stone-200 bg-stone-100 text-2xl font-semibold text-stone-500">
            {user.image ? (
          ...
          <div>
            ...
            <h1 className="mt-1 text-[var(--text-2xl)] font-semibold text-stone-800">
              기록자 프로필 · {user.name}
            </h1>
          </div>
        </div>
      ...
      <div className="mt-5 border border-stone-200 bg-stone-50 p-4 text-sm leading-7 text-stone-600">
